...
CONFIG.rt_1 = [2, 3, 3, 4, 5, 4, 5, 5, 5, 5, 7, 6, 7, 6, 5, 4];//con 1 cap
CONFIG.rt_2 = [2, 3, 3, 4, 5, 5, 5, 6, 6, 5, 5, 5, 6, 5, 5, 4];// con 2 cap
CONFIG.rt_3 = [2, 3, 3, 3, 4, 4, 4, 5, 4, 5, 5, 4, 5, 4, 4, 3];// con 3 cap
CONFIG.rt_4 = [2, 3, 3, 3, 4, 3, 4, 4, 4, 3, 4, 4, 3, 4, 3, 3];// con 4 cap
CONFIG.rt_5 = [2, 2, 2, 3, 2, 3, 2, 3, 3, 3, 2, 2, 2, 3, 3, 2];// con >= 5 cap
...
CONFIG.rto_1 = [0.8, 1.7, 1.5, 2.4, 2.5, 3.0, 3.0, 3.0, 3.0, 3.1, 3.2, 3.3, 3.3, 3.5, 3.5, 3.3];
...
CONFIG.rto_5 = [1.5, 1.7, 1.7, 1.7, 1.8, 1.8, 1.8, 2.0, 2.0, 2.1, 2.1, 2.2, 2.0, 2.1, 2.2, 2.2];
